        ...
        <meta name="description" content="<?php  echo  ($title? ucfirst($title) :'Prembless Pharmacy')?>">
        <meta name="author" content="Bdtask">
        <title><?php  echo  ($title? ucfirst($title):'Prembless Pharmacy')?> - Prembless Pharmacy</title>
        <?php 
